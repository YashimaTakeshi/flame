...
- 留める舞台は 100svh。iPhone の Safari では 390×844 の機種でも svh は約 660px、iPhone SE では約 550px しかない。作品・束・比率の額・冒頭の額は、画面の高さから下のラベルやメーターの分（`--walk-room` など）を引いた大きさまで縮める。確かめるときは 390×664・375×553・320×568・横向き 844×390 でも撮る
